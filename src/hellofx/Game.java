...
public class Game {
    ...
    private List<CornCube.CornType> cubes;

    public Game() {
        // Initialize the cubes list
        cubes = new ArrayList<>();
        // Example: Add some cubes to the list
        cubes.add(CornCube.CornType.GREEN);
        cubes.add(CornCube.CornType.BLUE);
        cubes.add(CornCube.CornType.YELLOW);
    }

    public List<CornCube.CornType> getCubes() {
        return cubes;
    }
